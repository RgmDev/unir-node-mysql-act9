...
START TRANSACTION;
USE `blog`;
INSERT INTO `blog`.`authors` (`id`, `name`, `email`, `image`, `created_at`, `updated_at`) VALUES (DEFAULT, 'Rubén González Martín', 'ruben.gonzalez@mail.com', 'https://picsum.photos/id/237/400/400', DEFAULT, DEFAULT);
INSERT INTO `blog`.`authors` (`id`, `name`, `email`, `image`, `created_at`, `updated_at`) VALUES (DEFAULT, 'Patricia Martín Muñoz', 'patricia.martin@mail.com', 'https://picsum.photos/id/1005/400/400', DEFAULT, DEFAULT);
...
START TRANSACTION;
USE `blog`;
INSERT INTO `blog`.`posts` (`id`, `title`, `description`, `post_date`, `authors_id`, `categories_id`, `created_at`, `updated_at`) VALUES (DEFAULT, 'Mi primer post - Rubén', 'Lorem ipsum dolor sit amet consectetur adipiscing elit in, facilisis augue netus conubia suspendisse suscipit curabitur', '2022-10-01', 1, 1, DEFAULT, DEFAULT);
INSERT INTO `blog`.`posts` (`id`, `title`, `description`, `post_date`, `authors_id`, `categories_id`, `created_at`, `updated_at`) VALUES (DEFAULT, 'Mi segundo post - Rubén', 'Lorem ipsum dolor sit amet consectetur adipiscing elit in, facilisis augue netus conubia suspendisse suscipit curabitur', '2022-10-02', 1, 1, DEFAULT, DEFAULT);
